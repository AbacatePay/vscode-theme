...
function M.setup()
	...
	h("Conditional", { fg = M.palette.orange, bold = true })
	h("Repeat", { fg = M.palette.orange, bold = true })
	h("Statement", { fg = M.palette.orange, bold = true })
	h("@keyword.control", { fg = M.palette.orange, bold = true })
	h("@keyword.return", { fg = M.palette.orange, bold = true })

	h("Operator", { fg = M.palette.peach_whitish })

	h("Function", { fg = M.palette.orange_light })
	h("@function", { fg = M.palette.orange_light })
	h("@method", { fg = M.palette.orange_light })
	h("@function.call", { fg = M.palette.orange_light })
	h("@method.call", { fg = M.palette.orange_light })

	h("Type", { fg = M.palette.peach_whitish })
	h("@type", { fg = M.palette.peach_whitish })

	h("String", { fg = M.palette.seed_brown })
	h("@string", { fg = M.palette.seed_brown })

	h("Constant", { fg = M.palette.orange_brand })
	h("@constant", { fg = M.palette.orange_brand })
	h("@constant.builtin", { fg = M.palette.orange_brand })
	h("@constant.macro", { fg = M.palette.orange_brand })
	h("@variable.constant", { fg = M.palette.orange_brand })
	h("@lsp.type.enumMember", { fg = M.palette.orange })

	h("@lsp.type.variable.readonly", { fg = M.palette.orange })
	h("@lsp.typemod.variable.readonly", { fg = M.palette.orange })
	h("@lsp.typemod.variable.static", { fg = M.palette.orange })

	h("Number", { fg = M.palette.orange_brand })
	h("Boolean", { fg = M.palette.orange_brand })
	h("@variable", { fg = M.palette.light_green })
	...
	h("LineNr", { fg = "#2C3133" })
	h("CursorLineNr", { fg = M.palette.orange, bold = true })
	...
	h("CmpItemAbbrMatch", { fg = M.palette.orange, bold = true })
	h("CmpItemKindFunction", { fg = M.palette.orange_brand })
	h("CmpItemKindKeyword", { fg = M.palette.orange })
	...
	h("MatchParen", { bg = M.palette.selection, fg = M.palette.orange, bold = true })
	...
	h("AlphaHeader", { fg = M.palette.orange_brand })
	h("AlphaButtons", { fg = M.palette.orange })
	h("AlphaShortcut", { fg = M.palette.yellow })
	h("DashboardHeader", { fg = M.palette.orange_brand })
	h("DashboardCenter", { fg = M.palette.orange })
	h("DashboardShortcut", { fg = M.palette.yellow })
	h("DashboardFooter", { fg = M.palette.olive })

	h("SnacksDashboardHeader", { fg = M.palette.orange_brand })
	h("SnacksDashboardIcon", { fg = M.palette.orange })
	h("SnacksDashboardKey", { fg = M.palette.yellow })
	h("SnacksDashboardDesc", { fg = M.palette.orange })
	h("SnacksDashboardDir", { fg = M.palette.light_green })
	h("SnacksDashboardFile", { fg = M.palette.fg })
	h("SnacksDashboardSpecial", { fg = M.palette.orange_brand })

	h("Label", { fg = M.palette.orange })
	h("SpecialKey", { fg = M.palette.orange })
	...
	h("@lsp.type.type", { fg = M.palette.peach_whitish })
	h("@lsp.type.parameter", { fg = M.palette.light_green })
	h("@lsp.type.property", { fg = M.palette.olive })
	h("@lsp.type.enumMember", { fg = M.palette.orange })
	h("@lsp.type.function", { fg = M.palette.orange_light })
	h("@lsp.type.method", { fg = M.palette.orange_light })
	...
	h("markdownCode", { fg = M.palette.seed_brown })
	h("markdownCodeBlock", { fg = M.palette.seed_brown })
	...
	h("@markup.raw", { fg = M.palette.seed_brown })
