...
function M.setup()
	...
	h("Identifier", { fg = M.palette.beige })
	h("@variable", { fg = M.palette.fg })
	h("@variable.parameter", { fg = M.palette.beige, italic = true })
	h("@variable.member", { fg = M.palette.beige })
	h("@variable.property", { fg = M.palette.beige })
	...
	h("@type", { fg = M.palette.beige })
	h("String", { fg = M.palette.orange_light })
	h("@string", { fg = M.palette.orange_light })
	h("Constant", { fg = M.palette.orange })
	h("@constant", { fg = M.palette.orange })
	h("@constant.builtin", { fg = M.palette.orange })
	h("@constant.macro", { fg = M.palette.orange })
	h("@variable.constant", { fg = M.palette.orange })
	...
	h("Number", { fg = M.palette.orange })
	h("Boolean", { fg = M.palette.orange })
	...
	h("GitSignsAdd", { fg = M.palette.olive })
	...
	h("SnacksDashboardSpecial", { fg = M.palette.orange })
	...
	h("markdownH4", { fg = M.palette.beige, bold = true })
